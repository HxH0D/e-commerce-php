            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-dark bg-light px-2">Ürün</span>
                        <span class="h1 text-uppercase text-light bg-primary px-2 ml-n1">Burada</span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="shop.php" class="nav-item nav-link">Mağaza</a>
                            <!-- <a href="detail.php" class="nav-item nav-link">Mağaza Detayı</a> -->
                            <!-- <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Sayfa <i class="fa fa-angle-down mt-1"></i></a>
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    <a href="cart.php" class="dropdown-item">Alışveriş Sepeti</a>
                                    <a href="checkout.php" class="dropdown-item">Çıkış Yapmak</a>
                                </div>
                            </div> -->
